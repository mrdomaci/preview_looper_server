  ...
  <div class="card m-4">
    ...
    <div class="card-body">
        ...
        <div class="form-group row mt-4">
            ...
            <div class="col-md-6">
                <select class="form-control" name="settings_infinite_repeat" id="settings_infinite_repeat" disabled>
                <option
                    value="0"
        ...
        <div class="form-group row mt-4">
            ...
            <div class="col-md-6">
                <select class="form-control" name="settings_return_to_default" id="settings_return_to_default" disabled>
                    <option
                        value="0"
        ...
        <div class="form-group row mt-4">
            ...
            <div class="col-md-6">
                <select class="form-control" name="settings_show_time" id="settings_show_time" disabled>
                    <option
                        value="1000"
                        @if ($show_time <= 1000)
                            selected 
